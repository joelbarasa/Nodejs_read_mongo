...
async function main() {
   ...
   */
  const uri =
    "mongodb+srv://username:password@cluster0.zvocyod.mongodb.net/?retryWrites=true&w=majority";
  ...
  try {
    ...
    const database = client.db("RioDBase");
    const movies = database.collection("RioCollection");
